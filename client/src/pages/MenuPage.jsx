...
function MenuPage() {
  ...
  return (
    <div className="w-screen min-h-screen bg-gray-900 text-white overflow-x-hidden">
      ...
      <div className="relative w-full bg-gradient-to-r from-gray-800 via-gray-900 to-gray-800 py-12 sm:py-16 md:py-20 px-4">
      ...
      {/* Menu Items Grid */}
      {!loading && !error && (
        <div className="w-full max-w-7xl mx-auto px-4 py-12 sm:py-16 md:py-20">
          {menuItems.length === 0 ? (
